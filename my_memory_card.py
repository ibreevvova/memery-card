...
questions_list.append(Question('Год отмены крепостного права в Российской империи?', '1861', '587', '1825', '2018'))
questions_list.append(Question('точная дата начала 2 мировой войны?', '1 сентября 1939', '6 марта 653', '1 сентября 1835', '5 февраля 973'))
